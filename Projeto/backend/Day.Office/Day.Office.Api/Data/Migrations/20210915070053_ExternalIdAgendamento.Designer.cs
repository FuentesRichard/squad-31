...
namespace Day.Office.Api.Data.Migrations
{
    ...
    [Migration("20210915070053_ExternalIdAgendamento")]
    partial class ExternalIdAgendamento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Day.Office.Api.Entities.Agendamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("IdEstacaoTrabalho")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Day.Office.Api.Entities.Agendamento", b =>
                {
                    b.HasOne("Day.Office.Api.Entities.EstacaoTrabalho", "EstacaoTrabalho")
                        .WithMany("Agendamentos")
                        .HasForeignKey("IdEstacaoTrabalho")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Day.Office.Api.Entities.Funcionario", "Funcionario")
                        .WithMany("Agendamentos")
                        .HasForeignKey("IdFuncionario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EstacaoTrabalho");
